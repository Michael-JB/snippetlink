...
does not leave your device. It uses no frameworks or dependencies and is served
statically without tracking code.

## See also

I created snippet as a minimalist, code-oriented alternative to
